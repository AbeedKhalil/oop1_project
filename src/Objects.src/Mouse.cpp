...
void Mouse::moveMouse(const std::vector<std::shared_ptr<Objects>>& movingobjects, std::vector<std::shared_ptr<Objects>> objects, float moveX, float moveY, Score score)
{
